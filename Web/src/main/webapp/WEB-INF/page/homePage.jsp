...
<head>
    ...
    <script type="text/javascript" src="web/js/roomSend.js"></script>
...
<div class="noprint">
    <header></header>
    <div class="language">
        <img src="web/images/RU.png" width="24" height="24" class="lang ruImg">
    ...
    <fmt:bundle basename="pagecontent" prefix="login_">
        <div class="windowLogIn">
            <form class="formLogin">
                ...
                <input type="button" value="<fmt:message key="logInButton"/>" class="logInButton"/><br><br>
                <a href="#" class="showWindowSignUp"><fmt:message key="signUp"/></a>
                <span class="closeWindowLogin"></span>
            </form>
        </div>
    </fmt:bundle>
    ...
    <fmt:bundle basename="pagecontent" prefix="signUp_">
        <div class="windowSignUp">
            ...
            <div>
                <input type="button" value="<fmt:message key="signUpButton"/>" class="signUpButton"/><br>
    ...
    <fmt:bundle basename="pagecontent" prefix="windowMessage_">
        <div class="windowMessage">
            ...
            <input type="button" value="<fmt:message key="closeWindowMessage"/>" class="closeMessage"/>
        </div>
    </fmt:bundle>
...
<script type="text/javascript" src="web/js/exp.js"></script>
</body>
</html>
